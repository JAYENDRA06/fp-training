...
namespace firstapi.Controllers
{
    ...
    public class FlightController(IRepository repository) : ControllerBase
    {
        ...
        public async Task<IActionResult> EditFlight(string id, FlightsJay flightsJay)
        {
            ...
            try
            {
                await _repository.EditEntity(flightsJay);
            }
        ...
        [HttpPost]
        public async Task<ActionResult<FlightsJay>> AddFlight(FlightsJay flightsJay)
        {
            try
            {
                await _repository.AddEntity(flightsJay);
            }
            ...
            return CreatedAtAction("GetFlightsJay", new { id = flightsJay.FlightNumber }, flightsJay);
        }
        ...
        public async Task<IActionResult> DeleteFlight(string id)
        {
            ...
            await _repository.DeleteEntity(flightsJay);
