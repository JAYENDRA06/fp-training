using banking_project_ssms.Models;
...
while (loop)
{
    ...
    switch (choice)
    {
        ...
        case 2:
            {
                List<SbaccountJay>? accounts = bankRepository.GetAllAccounts();
                ...
                try
                {
                    if (accounts != null)
                    {
                        ...
                        foreach (SbaccountJay account in accounts)
                        {
        ...
        case 3:
            {
                ...
                SbaccountJay? account = bankRepository.GetAccountDetails(_accountNumber);
        ...
        case 6:
            {
                Console.WriteLine("Enter the account number");
                int _accountNumber = Convert.ToInt32(Console.ReadLine());
                List<SbtransactionJay>? transactions = bankRepository.GetTransactions(_accountNumber);
                ...
                try
                {
                    if (transactions != null)
                    {
                        ...
                        foreach (SbtransactionJay transaction in transactions)
                        {
